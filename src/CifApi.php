...
class CifApi
{
     ...
     * API Endpoints
     */
    const API_ADDRESS_LIVE = 'https://api-sandbox.postnl.nl';
    const API_ADDRESS_TEST = 'https://api.postnl.nl';
     ...
     * @return \Avido\PostNLCifClient\Response\
     */
    public function getNearestLocations(Request\DeliveryOptions\Location\NearestLocationsRequest $request)
    {
